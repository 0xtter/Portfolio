...
export default function LanguageSwitchButton() {
	...
	return (
		<LanguageWrapper>
			<Image src="/img/frfr.png" alt="Drapeau Francais" width={28} height={28} style={{ objectFit: "cover" }} />
			<SwitchButton>
			...
			<Image src="/img/enuk.png" alt="Drapeau Angleterre" width={28} height={28} style={{ objectFit: "cover" }} />
		</LanguageWrapper>
	);
}
